...
% PSDU_InputData = Input_Constant(PSDU_SignalBuilder);
% PSDU_InputData = DriveFromAxle(PSDU_SignalBuilder);
% PSDU_InputData = DriveWithMG2(PSDU_SignalBuilder);
% PSDU_InputData = DriveWithMG1(PSDU_SignalBuilder);
% PSDU_InputData = DriveWithMG1_LockAxle(PSDU_SignalBuilder);
PSDU_InputData = StartEngineWithMG1_ThenSplitPower(PSDU_SignalBuilder);

PSDU_InputSignals = PSDU_InputData.Signals;
PSDU_InputBus = PSDU_InputData.Bus;

t_end = PSDU_InputData.Options.StopTime_s;
