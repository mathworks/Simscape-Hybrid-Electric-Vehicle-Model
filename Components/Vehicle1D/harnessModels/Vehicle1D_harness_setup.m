...
% For Custom road profile block.
% This is used by the "withRoadProfile" subsystem.
road.HorizontalDistanceVec_m = [-200 -100 0 10 300 400 500];
road.VerticalProfileVec_m =    [   0    0 0  0  20  20  20];
road.vehicleWheelbase_mm = 3000;
initial.road_vehicleHorizontalPosition_m = -10;
